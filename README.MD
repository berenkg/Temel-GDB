...
<h3>NOT:</h3> disassembly komutu uygulanırken intel ailesine uygun syntax'ta assembly kodları göremeyebilirsiniz. Bunu düzeltmek için `set disassembly-flover intel` komutunu uygulamanız gerekmektedir.
